...
export function PositionsList() {
  ...
  return (
    <div>
      ...
      {!isConnected && (
        <div className="mt-10 border border-white/15 p-12 text-center text-sm text-neutral-400">
          Connect a wallet to see your positions.
        </div>
      )}

      {isConnected && loading && !rows && (
        <div className="mt-10 border border-white/15 p-12 text-center text-sm text-neutral-500">Loading…</div>
      )}
